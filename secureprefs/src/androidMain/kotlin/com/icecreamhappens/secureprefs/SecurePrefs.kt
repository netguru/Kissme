 ...
 * It uses [EncryptedSharedPreferences] under the hood.
 * [EncryptedSharedPreferences] are initialized automatically by using [AndroidStorageProvider].
...
internal inline fun SharedPreferences.edit(action: SharedPreferences.Editor.() -> Unit) = with(edit()) {
    action()
    apply()
}
