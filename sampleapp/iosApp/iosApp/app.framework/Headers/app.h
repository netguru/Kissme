...
@class AppMainPresenter, AppMainPresenterCompanion;
...
- (void)attachViewView:(id<AppMainView>)view __attribute__((swift_name("attachView(view:)")));
- (void)detachView __attribute__((swift_name("detachView()")));
- (void)addNewToDoElementItem:(NSString *)item __attribute__((swift_name("addNewToDoElement(item:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainPresenter.Companion")))
@interface AppMainPresenterCompanion : KotlinBase
...
@protocol AppMainView
@required
- (void)showElementAddedInfo __attribute__((swift_name("showElementAddedInfo()")));
- (void)showToDoListToDoList:(NSArray<NSString *> *)toDoList __attribute__((swift_name("showToDoList(toDoList:)")));
@end;
